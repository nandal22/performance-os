...
import { Home, Clock, TrendingUp, Target, Scale, Settings, Dumbbell, Flame } from 'lucide-react';
        ...
        {TABS.map(({ path, icon: Icon, label }) => {
          ...
          return (
            <Link
              key={path}
              to={path}
              className="min-w-[48px] flex-1 flex flex-col items-center gap-0.5 py-2.5 relative"
            >
